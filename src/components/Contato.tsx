...
const Contato = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Reset mensagem de confirmação após 5 segundos
      setTimeout(() => {
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+55 (11) 99000-0000</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">contato@proquality.com.br</p>
                  <p className="text-gray-600">comercial@proquality.com.br</p>
                </div>
              </div>
            </div>
