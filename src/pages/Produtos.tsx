...
const categorias = [
  {
    ...
    name: "Orgânicos",
    description:
      "Produtos cultivados sem o uso de agrotóxicos, fertilizantes químicos ou organismos geneticamente modificados, seguindo práticas sustentáveis que respeitam o meio ambiente e promovem a saúde do consumidor.",
  ...
  },
  {
    ...
    description:
      "Produtos vegetais frescos ou minimamente processados que passaram por etapas de seleção, classificação, limpeza ou beneficiamento, assegurando padronização, rastreabilidade e segurança alimentar.",
  ...
  },
  {
    ...
    description:
      "Produtos vegetais submetidos a processos industriais como beneficiamento, moagem ou secagem, mantendo a rastreabilidade, os padrões de qualidade e a segurança alimentar exigida pela legislação.",
  ...
  },
  {
    ...
    description:
      "Óleos extraídos de sementes, polpas ou frutos, refinados para uso alimentício e industrial, com garantia de qualidade e conformidade com normas sanitárias.",
  ...
  },
  {
    ...
    description:
      "Produtos vegetais com finalidades industriais, comerciais ou técnicas específicas, abrangendo matérias-primas, derivados e itens com particularidades no processamento ou uso.",
  ...
  },
  {
    ...
    description:
      "Sistema de produção agrícola que adota práticas sustentáveis de manejo, priorizando a conservação dos recursos naturais, a rastreabilidade e a redução do uso de insumos químicos.",
    image: "/images/producao.jpg",    
    examples: [
      "Fruticultura Integrada",
      "Olericultura Integrada",
      "Culturas Anuais (Milho, Soja, Arroz, etc.)",
